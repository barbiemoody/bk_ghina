...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="http://<?= $_SERVER['HTTP_HOST']?>/bk_ghina/pages/auth/destroy.php" class="dropdown-item">Logout</a>
        </div>
    </li>
</ul>
</nav>
...
<div class="sidebar bg-primary" >
    ...
    <style>
         .sidebar {
    background-color:rgb(60, 138, 118) !important; /* Green color */
        ...
        <nav class="mt-2">
            ...
            with font-awesome or any other icon font library -->
                <?php if ($_SESSION['akses'] == 'admin') : ?>
                    ...
                    <li class="nav-item">
                    <a href="http://<?= $_SERVER['HTTP_HOST']?>/bk_ghina/pages/auth/destroy.php" class="nav-link">
